...
function WrapComponent(props: any) {
    ...
    const introMainFn=()=>{
        ...
        localStorage.setItem('KURLYPAGE','intro');
    }
    ...
    const subMain1Fn=()=>{
        ...
        setIsMemberSignUp(false);  // 회원가입폼 숨긴다.
        setIsMemberSignIn(false); // 로그인 숨긴다.
        localStorage.setItem('KURLYPAGE','main1');
    }
    ...
    const memberSignUpFn=()=>{
        ...
        setIsSubMain1(false);  // 서브 메인1 숨긴다
        setIsMemberSignIn(false); // 로그인 숨긴다.
        localStorage.setItem('KURLYPAGE','signup');
    }

    React.useEffect(()=>{
        
        const result = localStorage.getItem('KURLYPAGE');
    ...
    const memberSignInFn=()=>{
        ...
        setIsIntroMain(false);  // 인트로 메인 숨긴다.
        setIsSubMain1(false);  // 서브 메인1 숨긴다
        localStorage.setItem('KURLYPAGE','signin');
    }
